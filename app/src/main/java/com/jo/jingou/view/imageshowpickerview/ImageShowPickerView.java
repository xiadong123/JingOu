...
public class ImageShowPickerView extends LinearLayout {
     ...
     * @param isShowAddPic
     */
    public void setIsShowAddPic(boolean isShowAddPic) {
    ...
    private void viewTypedArray(Context context, AttributeSet attrs) {
        ...
        mPicSize = typedArray.getDimensionPixelSize(R.styleable.ImageShowPickerView_pic_size, SizeUtils.getSizeUtils
                ().dp2px(getContext(), PIC_SIZE));
        ...
        mAddLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_add_label, R.drawable
                .image_show_piceker_add1);
        mDelLabel = typedArray.getResourceId(R.styleable.ImageShowPickerView_del_label, R.drawable
                .image_show_piceker_del);
        oneLineShowNum = typedArray.getInt(R.styleable.ImageShowPickerView_one_line_show_num, ONE_LINE_SHOW_NUM);
        isShowAddPic = typedArray.getBoolean(R.styleable.ImageShowPickerView_is_show_add_pic, true);
        Log.e("viewTypedArray", isShowAddPic + "--");
...
//        recyclerView.setLayoutParams(layoutParams);
        ...
        adapter.setShowAddPic(isShowAddPic);
