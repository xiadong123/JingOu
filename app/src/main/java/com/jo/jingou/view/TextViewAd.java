...
public class TextViewAd extends TextView {
    ...
    private void init() {
        ...
        mPaintFront.setTextSize(Utility.dip2px(getContext(), 13));
        mPaintFront.setColor(0xFFF66C24);

        mPaintBack = new Paint();
        mPaintBack.setAntiAlias(true);
        mPaintBack.setDither(true);
        mPaintBack.setTextSize(Utility.dip2px(getContext(), 13));
        mPaintBack.setColor(0xFFF66C24);
    }
